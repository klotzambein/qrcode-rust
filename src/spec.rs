...
//!     println!("spec_normal! {{");
//!     for i in 0..40 {
//!         let ec_per_block = EC_BYTES_PER_BLOCK[i][0];
//!         let (s1, c1, s2, c2) = DATA_BYTES_PER_BLOCK[i][0];
//!         let total_size = ec_per_block * (c1 + c2) + s1 * c1 + s2 * c2;
//!         let width = i * 4 + 21;
//!         println!(
//!             "  Version{}, {}, {}, {} => [",
//!             i + 1,
...
macro_rules! spec_normal_level {
    ($name:ident, $level:ty, $ec_level:expr, $total_size:ty, $ec_gen_buffer_size:ty, $ec_blocks_size:ty, $canvas_color_size:ty, $bits_size:ty, $version_num:expr, $block_1_size:expr, $block_1_count:expr, $block_2_size:expr, $block_2_count:expr, $ec_bytes_per_block:expr) => {
        impl QrSpec for $name<$level> {
            ...
            type CanvasSize = $canvas_color_size;
            type ColorSize = $canvas_color_size;
...
macro_rules! spec_normal {
    {$($name:ident, $total_size:ty, $canvas_color_size:ty, $version_num:expr => [
        ...
        spec_normal_level!($name, EcLevelL, EcLevel::L, $total_size, $ec_gen_buffer_size_l, $ec_blocks_size_l, $canvas_color_size, $bits_size_l, $version_num, $block_1_size_l, $block_1_count_l, $block_2_size_l, $block_2_count_l, $ec_bytes_per_block_l);
        spec_normal_level!($name, EcLevelM, EcLevel::M, $total_size, $ec_gen_buffer_size_m, $ec_blocks_size_m, $canvas_color_size, $bits_size_m, $version_num, $block_1_size_m, $block_1_count_m, $block_2_size_m, $block_2_count_m, $ec_bytes_per_block_m);
        spec_normal_level!($name, EcLevelQ, EcLevel::Q, $total_size, $ec_gen_buffer_size_q, $ec_blocks_size_q, $canvas_color_size, $bits_size_q, $version_num, $block_1_size_q, $block_1_count_q, $block_2_size_q, $block_2_count_q, $ec_bytes_per_block_q);
        spec_normal_level!($name, EcLevelH, EcLevel::H, $total_size, $ec_gen_buffer_size_h, $ec_blocks_size_h, $canvas_color_size, $bits_size_h, $version_num, $block_1_size_h, $block_1_count_h, $block_2_size_h, $block_2_count_h, $ec_bytes_per_block_h);
    )*};
}
...
spec_normal! {
  ...
  Version4, U100, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B0>, B0>, B1>, B0>, B0>, B0>, B0>, B0>, B1>, 4 => [
    { U100, U20, U80, 80, 1, 0, 0, 20 },
    { U50, U36, U64, 32, 2, 0, 0, 18 },
    { U50, U52, U48, 24, 2, 0, 0, 26 },
    { U25, U64, U36, 9, 4, 0, 0, 16 },
  ],
  Version5, U134, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B1>, B0>, B1>, B0>, B1>, B1>, B0>, B0>, B1>, 5 => [
    { U134, U26, U108, 108, 1, 0, 0, 26 },
    { U67, U48, U86, 43, 2, 0, 0, 24 },
    { U34, U72, U62, 15, 2, 16, 2, 18 },
    { U34, U88, U46, 11, 2, 12, 2, 22 },
  ],
  Version6, U172, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B1>, B0>, B1>, B0>, B0>, B1>, B0>, B0>, B0>, B1>, 6 => [
    { U86, U36, U136, 68, 2, 0, 0, 18 },
    { U43, U64, U108, 27, 4, 0, 0, 16 },
    { U43, U96, U76, 19, 4, 0, 0, 24 },
    { U43, U112, U60, 15, 4, 0, 0, 28 },
  ],
  Version7, U196, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B1>, B1>, B1>, B1>, B1>, B0>, B1>, B0>, B0>, B1>, 7 => [
    { U98, U40, U156, 78, 2, 0, 0, 20 },
    { U49, U72, U124, 31, 4, 0, 0, 18 },
    { U33, U108, U88, 14, 2, 15, 4, 18 },
    { U40, U130, U66, 13, 4, 14, 1, 26 },
  ],
  Version8, U242, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B0>, B1>, B0>, B1>, B1>, B0>, B0>, B0>, B0>, B1>, 8 => [
    { U121, U48, U194, 97, 2, 0, 0, 24 },
    { U61, U88, U154, 38, 2, 39, 2, 22 },
    { U41, U132, U110, 18, 4, 19, 2, 22 },
    { U41, U156, U86, 14, 4, 15, 2, 26 },
  ],
  Version9, U292, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B1>, B0>, B1>, B1>, B1>, B1>, B1>, B0>, B0>, B1>, 9 => [
    { U146, U60, U232, 116, 2, 0, 0, 30 },
    { U59, U110, U182, 36, 3, 37, 2, 22 },
    { U37, U160, U132, 16, 4, 17, 4, 20 },
    { U37, U192, U100, 12, 4, 13, 4, 24 },
  ],
  Version10, U346, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B1>, B0>, B0>, B1>, B0>, B1>, B1>, B0>, B0>, B0>, B1>, 10 => [
    { U87, U72, U274, 68, 2, 69, 2, 18 },
    { U70, U130, U216, 43, 4, 44, 1, 26 },
    { U44, U192, U154, 19, 6, 20, 2, 24 },
    { U44, U224, U122, 15, 6, 16, 2, 28 },
  ],
  Version11, U404, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B1>, B1>, B0>, B1>, B0>, B0>, B0>, B1>, B0>, B0>, B1>, 11 => [
    { U101, U80, U324, 81, 4, 0, 0, 20 },
    { U81, U150, U254, 50, 1, 51, 4, 30 },
    { U51, U224, U180, 22, 4, 23, 4, 28 },
    { U37, U264, U140, 12, 3, 13, 8, 24 },
  ],
  Version12, U466, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B0>, B0>, B0>, B1>, B0>, B0>, B0>, B0>, B0>, B0>, B1>, 12 => [
    { U117, U96, U370, 92, 2, 93, 2, 24 },
    { U59, U176, U290, 36, 6, 37, 2, 22 },
    { U47, U260, U206, 20, 4, 21, 6, 26 },
    { U43, U308, U158, 14, 7, 15, 4, 28 },
  ],
  Version13, U532, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B0>, B1>, B0>, B1>, B0>, B0>, B1>, B1>, B0>, B0>, B1>, 13 => [
    { U133, U104, U428, 107, 4, 0, 0, 26 },
    { U60, U198, U334, 37, 8, 38, 1, 22 },
    { U45, U288, U244, 20, 8, 21, 4, 24 },
    { U34, U352, U180, 11, 12, 12, 4, 22 },
  ],
  Version14, U581, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B1>, B0>, B0>, B1>, B1>, B0>, B1>, B0>, B0>, B0>, B1>, 14 => [
    { U146, U120, U461, 115, 3, 116, 1, 30 },
    { U65, U216, U365, 40, 4, 41, 5, 24 },
    { U37, U320, U261, 16, 11, 17, 5, 20 },
    { U37, U384, U197, 12, 11, 13, 5, 24 },
  ],
  Version15, U655, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B1>, B1>, B1>, B0>, B0>, B1>, B0>, B1>, B0>, B0>, B1>, 15 => [
    { U110, U132, U523, 87, 5, 88, 1, 22 },
    { U66, U240, U415, 41, 5, 42, 5, 24 },
    { U55, U360, U295, 24, 5, 25, 7, 30 },
    { U37, U432, U223, 12, 11, 13, 7, 24 },
  ],
  Version16, U733, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B1>, B0>, B0>, B1>, B1>, B0>, B1>, B0>, B0>, B0>, B0>, B1>, 16 => [
    { U123, U144, U589, 98, 5, 99, 1, 24 },
    { U74, U280, U453, 45, 7, 46, 3, 28 },
    { U44, U408, U325, 19, 15, 20, 2, 24 },
    { U46, U480, U253, 15, 3, 16, 13, 30 },
  ],
  Version17, U815, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B1>, B1>, B0>, B0>, B0>, B0>, B1>, B1>, B1>, B0>, B0>, B1>, 17 => [
    { U136, U168, U647, 107, 1, 108, 5, 28 },
    { U75, U308, U507, 46, 10, 47, 1, 28 },
    { U51, U448, U367, 22, 1, 23, 15, 28 },
    { U43, U532, U283, 14, 2, 15, 17, 28 },
  ],
  Version18, U901, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B1>, B1>, B1>, B0>, B1>, B1>, B1>, B1>, B0>, B0>, B0>, B1>, 18 => [
    { U151, U180, U721, 120, 5, 121, 1, 30 },
    { U70, U338, U563, 43, 9, 44, 4, 26 },
    { U51, U504, U397, 22, 17, 23, 1, 28 },
    { U43, U588, U313, 14, 2, 15, 19, 28 },
  ],
  Version19, U991, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B0>, B0>, B0>, B1>, B1>, B1>, B0>, B0>, B1>, B0>, B0>, B1>, 19 => [
    { U142, U196, U795, 113, 3, 114, 4, 28 },
    { U71, U364, U627, 44, 3, 45, 11, 26 },
    { U48, U546, U445, 21, 17, 22, 4, 26 },
    { U40, U650, U341, 13, 9, 14, 16, 26 },
  ],
  Version20, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B0>, B0>, B0>, B1>, B1>, B1>, B1>, B0>, B1>, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B0>, B1>, B0>, B0>, B1>, B1>, B0>, B0>, B0>, B0>, B0>, B1>, 20 => [
    { U136, U224, U861, 107, 3, 108, 5, 28 },
    { U68, U416, U669, 41, 3, 42, 13, 26 },
    { U55, U600, U485, 24, 15, 25, 5, 30 },
    { U44, U700, U385, 15, 15, 16, 10, 28 },
  ],
  Version21, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B0>, B1>, B0>, B0>, B0>, B0>, B1>, B0>, B0>, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B0>, B1>, B1>, B1>, B1>, B1>, B0>, B1>, B1>, B0>, B0>, B1>, 21 => [
    { U145, U224, U932, 116, 4, 117, 4, 28 },
    { U68, U442, U714, 42, 17, 0, 0, 26 },
    { U51, U644, U512, 22, 17, 23, 6, 28 },
    { U47, U750, U406, 16, 19, 17, 6, 30 },
  ],
  Version22, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B0>, B1>, B1>, B1>, B0>, B1>, B0>, B1>, B0>, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B1>, B0>, B1>, B1>, B0>, B0>, B0>, B1>, B0>, B0>, B0>, B1>, 22 => [
    { U140, U252, U1006, 111, 2, 112, 7, 28 },
    { U74, U476, U782, 46, 17, 0, 0, 28 },
    { U55, U690, U568, 24, 7, 25, 16, 30 },
    { U37, U816, U442, 13, 34, 0, 0, 24 },
  ],
  Version23, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B1>, B0>, B1>, B0>, B1>, B0>, B1>, B0>, B0>, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B1>, B1>, B1>, B0>, B0>, B1>, B1>, B0>, B1>, B0>, B0>, B1>, 23 => [
  ...
  Version24, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B1>, B1>, B1>, B0>, B0>, B0>, B0>, B1>, B0>, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B1>, B0>, B0>, B0>, B1>, B1>, B1>, B1>, B0>, B0>, B0>, B0>, B1>, 24 => [
  ...
  Version25, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B1>, B0>,